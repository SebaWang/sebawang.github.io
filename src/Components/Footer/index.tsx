...
export default function Footer() {
    return (
        <footer className="footer p-10 bg-gray-300 text-neutral">
          <nav>
            <h6 className="footer-title">DATE</h6> 
            <a className=" ">2023</a>
            <a className=" ">5-Month Individual Project</a>
          </nav> 
          <nav>
            <h6 className="footer-title">ROLE</h6> 
            <a className=" ">Service Design</a>
            <a className=" ">UI / UX</a>
            <a className=" ">Operational Strategy</a>
          </nav> 
          <nav>
